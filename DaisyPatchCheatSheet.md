...
Example 1: if you put a jack in IN1 and leave the others unplugged, then in IN2, IN3, IN4 you'll have the same signal (and in the `AudioCallback` you'll have: `in[0][N]==in[1][N]==in[2][N]==in[3][N]` ).
